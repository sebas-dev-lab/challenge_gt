...
import GetterAppServer from './Infraestrucure/server/gt.app.server';
...
global.commonContext = {
    ...
    [contexts.task]: new CommonContext(uuidv4(), {}),
};

// ============== Set a conection ================= //
export const connection = new Connections([GetterAppServer]);
